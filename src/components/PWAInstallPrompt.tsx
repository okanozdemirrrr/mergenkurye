...
export function PWAInstallPrompt() {
  ...
  if (isIOS && !isStandalone && showInstallPrompt) {
    return (
      <div className="fixed bottom-4 left-4 right-4 z-50 bg-gradient-to-r from-orange-600 to-orange-700 text-white p-4 rounded-md shadow-sm border border-orange-500 animate-slide-up">
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="bg-white text-orange-600 font-semibold px-4 py-2 rounded-md hover:bg-orange-50 transition-colors text-sm"
              >
                Yükle
              </button>
              <button
                onClick={handleDismiss}
                className="bg-white/20 hover:bg-white/30 px-4 py-2 rounded-md transition-colors text-sm"
              >
                Daha Sonra
              </button>
            </div>
