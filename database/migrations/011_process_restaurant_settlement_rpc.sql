...
BEGIN
  ...
  IF to_regclass('public.restaurant_payment_transactions') IS NOT NULL THEN
    INSERT INTO restaurant_payment_transactions (
      ...
      v_total_revenue, v_courier_cost,
      GREATEST(v_net_paid, 0), GREATEST(v_net_paid, 0),
      v_package_count, v_affected_ids,
      COALESCE(p_notes, 'Mutabakat #' || v_settlement_id::TEXT),
