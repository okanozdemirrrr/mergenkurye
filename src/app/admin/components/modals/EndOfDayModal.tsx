                        ...
                        <>
                            ...
                            <div className="mb-6 space-y-3">
                                <div className="bg-green-50 p-4 rounded-md border border-green-200">
                                    ...
                                    <p className="text-xs text-green-700 mt-2 font-medium">
                                        Bu değer değişmez (bilgi amaçlı)
                                    </p>
                                </div>
                                ...
                                {/* Genel Toplam */}
                                <div className="bg-purple-50 p-4 rounded-md border-2 border-purple-300">
                                    <div className="flex justify-between items-center">
                            ...
                            <div className="mb-6">
                                ...
                                <input
                                    ...
                                    autoFocus
                                    className="w-full px-4 py-3 bg-slate-800 border-2 border-slate-300 rounded-md text-lg font-bold text-slate-900 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none"
                                />
                            </div>
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 px-4 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-md font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {processing ? (
