...
import { ClipboardList, Calendar, Banknote, CreditCard, Building2, Phone, Package as PackageIcon, Inbox, Rocket } from 'lucide-react'
...
export function HistoryView({
  ...
  return (
    <div id="history-container" className="bg-slate-900 shadow-sm rounded-md border border-slate-800 p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="px-4 py-2 bg-slate-800 border-slate-700 border-slate-300 rounded-md text-sm font-medium text-slate-700 focus:ring-2 focus:ring-orange-500 focus:border-transparent"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
        ...
        <div className="bg-emerald-50 p-3 rounded-md">
          <div className="text-xs uppercase tracking-wider text-emerald-600 font-medium flex items-center gap-1">
        ...
        <div className="bg-sky-50 p-3 rounded-md">
          <div className="text-xs uppercase tracking-wider text-sky-600 font-medium flex items-center gap-1">
        ...
        <div className="bg-purple-50 p-3 rounded-md">
          <div className="text-xs uppercase tracking-wider text-purple-600 font-medium flex items-center gap-1">
                  ...
                  <td className="py-3 px-4 font-medium">
                    ...
                    {pkg.customer_phone && (
                      <div className="text-xs text-slate-500 mt-1 flex items-center gap-1">
                        <Phone className="w-3 h-3" strokeWidth={1.5} /> {pkg.customer_phone}
                      </div>
                    )}
                  </td>
      ...
      {totalPages > 1 && (
        <div className="mt-6 flex justify-center items-center gap-2 flex-wrap">
          ...
          <button
            ...
            className="px-4 py-2 rounded-md font-medium transition-all bg-slate-200 text-slate-700 hover:bg-slate-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            ← Önceki
          </button>
