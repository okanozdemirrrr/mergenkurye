 ...
 * @description Anlık Sipariş Durumu Bileşeni.
 * Aktif operasyondaki siparişlerin (assigned, picking_up, on_the_way) 
 * yatay şerit halinde görüntülendiği War Room tarzı panel. 
 * Kompakt kartlar yan yana dizilir ve yatay kaydırma ile gezinilebilir.
 */
'use client'
...
export function OrderActivityFeed({
    ...
    return (
        <div className="bg-white dark:bg-slate-800 shadow-xl rounded-2xl p-4 mb-6">
            <h2 className="text-lg font-bold mb-3">🚀 Anlık Sipariş Durumu</h2>
