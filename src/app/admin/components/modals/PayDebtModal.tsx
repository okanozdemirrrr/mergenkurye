...
import { CreditCard, CheckCircle2, Banknote, AlertTriangle } from 'lucide-react'
...
export function PayDebtModal({
    ...
    return (
        <div className="fixed inset-0 bg-black/70 z-[60] flex items-center justify-center p-4">
            <div className="bg-white rounded-md max-w-2xl w-full max-h-[90vh] overflow-y-auto admin-scrollbar border border-slate-200">
                {/* Modal Header */}
                            ...
                            <div className="mb-6">
                                ...
                                {courierDebts.length === 0 ? (
                                    <div className="text-center py-8 text-slate-500">
                                        <CheckCircle2 className="w-8 h-8 mx-auto mb-2 text-green-500" strokeWidth={1.5} />
                                        <p>Ödenmemiş borç yok</p>
                                    </div>
                                ) : (
                                    <div className="space-y-2 mb-4">
                                        {courierDebts.map((debt) => (
                                            <div key={debt.id} className="flex justify-between items-center bg-red-50 p-3 rounded-md border border-red-200">
                                ...
                                <>
                                    <div className="mb-6">
                                        ...
                                        <input
                                            ...
                                            autoFocus
                                            className="w-full px-4 py-3 bg-slate-800 border-2 border-slate-300 rounded-md text-lg font-bold text-slate-900 focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none"
                                        />
                                    </div>
                                    ...
                                    {payDebtAmount && !isNaN(parseFloat(payDebtAmount)) && (() => {
                                        ...
                                        if (payment > totalDebt) {
                                            ...
                                            return (
                                                <div className="mb-6">
                                                    <div className="bg-green-50 p-4 rounded-md border-2 border-green-300">
                                                        <div className="text-center">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <button
                                            ...
                                            className="flex-1 px-4 py-3 bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white rounded-md font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            {processing ? (
