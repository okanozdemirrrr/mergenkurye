...
export default function UpdateAmountModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-[110] flex items-stretch lg:items-center justify-center p-0 lg:p-4" onClick={onClose}>
      <div
        className={`w-full h-full min-h-screen rounded-none p-6 overflow-y-auto lg:h-auto lg:min-h-0 lg:max-w-md lg:rounded-md border shadow-sm ${
